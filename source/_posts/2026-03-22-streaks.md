...
If I would allow myself for a dessert only now and then, I am pretty confident it would derail my sugar consumption, since _“every now and then”_ would be dictated by how much will power would be available on any given day, and there are days where I just have too much going on and will power is at short supply.
...
- At least one hike or long walk [every week]({% post_url 2025-11-16-joy_of_walking %}#consistency). 8+ year streak.
...
- On the first days of [each month]({% post_url 2024-09-01-investment-tracker %}) (normally the first weekend), go through every financial asset I own and write down their balance, invest or move stale funds. 8+ year streak.
